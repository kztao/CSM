...
class P11func_JW : public P11AdapterFunction
{
private:
    string Describe = "jw";
  	Mutex mutex;
	LibLoadManager *libLoadManager;
	CK_FUNCTION_LIST_PTR function_list_ptr;
	const char *libPath = "libpkcs11_api.so";
	CK_ATTRIBUTE ID = {CKA_ID,NULL,0};
	
	CK_OBJECT_HANDLE hKey_enc = 0;
	CK_OBJECT_HANDLE hKey_dec = 0;

	map<CK_SESSION_HANDLE,tmpSIDstruct>  map_tmpsid;

	P11func_JW(const P11func_JW& C);  
	P11func_JW &operator=(const P11func_JW &);  
