...
//	UtilsPrintData(VNAME(&context.state),32,0);
//	UtilsPrintData(VNAME(&context.count),8,0);
...
//	UtilsPrintData(VNAME(digest),outlen,0);
}

void GBCombine(BYTE *X, unsigned int bytelen1, BYTE *Y, unsigned int bytelen2, BYTE *XY, unsigned int *bytelen3)
{
	unsigned int len = 0;
	unsigned int j = 0;
	unsigned int i = 0;
...
int GBKDF(BYTE *Z, unsigned int bytelen, unsigned int klen, BYTE *ZOut, int Hashlen)
{
	unsigned int ct = 0;
	int bitlen = 0;
	int sl = 0;
    unsigned int Zctlen = 0;
	unsigned char *Zctbyte = NULL;
	unsigned char Hashbyte[32] = {0};
	unsigned char ctstr[4] = {0};
	unsigned int glen = 0;
	unsigned int hashblen = 0;
	int i = 0;
	int j = 0;
	int k = 0;
	int len = 0;
